...
\codeavailability{
  Python code for data preparation, neural network model training and visualization of model outputs is freely available at \url{https://github.com/weiji14/deepbedmap} (last access: 9~August~2020) and at \doi{10.5281/zenodo.3752613} \citep{LeongDeepBedMap2020}.
...
\dataavailability{
  The DeepBedMap\_DEM is available from Zenodo at \doi{10.5281/zenodo.3752613}  \citep{LeongDeepBedMap2020}.
